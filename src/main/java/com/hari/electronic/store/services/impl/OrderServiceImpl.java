...
import com.hari.electronic.store.entities.*;
...
import com.hari.electronic.store.repositories.*;
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderDto createOrder(CreateOrderRequest orderDto) {
        ...
        //fetch cart
        Cart cart = cartRepository.findById(cartId).orElseThrow(() -> new ResourceNotFoundException("Cart with given id doesn't exist!"));
    ...
    public void removeOrder(String orderId) {
        ...
        Order order = orderRepository.findById(orderId).orElseThrow(() -> new ResourceNotFoundException("Order with given id doesn't exist!"));
